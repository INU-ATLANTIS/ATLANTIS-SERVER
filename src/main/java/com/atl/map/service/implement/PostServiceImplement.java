...
public class PostServiceImplement implements PostService {
    ...
    public ResponseEntity<? super GetLatestPostResponseDto> getLatestPostList() {
        List<PostListViewEntity> postListViewEntities =
                postListViewRepository.findByOrderByWriteDatetimeDesc();
    ...
    public ResponseEntity<? super GetSearchPostListResponseDto> getSearchPostList(String searchWord) {
        List<PostListViewEntity> postListViewEntities =
                postListViewRepository.findByTitleContainsOrContentContainsOrderByWriteDatetimeDesc(searchWord, searchWord);
    ...
    public ResponseEntity<? super GetBuildingPostListResponseDto> getBuildingPostList(Integer buildingId) {
        List<PostListViewEntity> postListViewEntities =
                postListViewRepository.findByBuildingIdOrderByWriteDatetimeDesc(buildingId);
